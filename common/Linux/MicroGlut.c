...
// Whatever happened here I didn't write down.
// 2024-04-19: Corrected glutMouseIsDown
...
//      int op = 0;
      while (XPending(dpy) > 0)
      {
         ...
         {
         	case ClientMessage:
         		if ((unsigned int)event.xclient.data.l[0] == wmDeleteMessage) // quit!
         			gRunning = 0;
	         	break;
         	case Expose: 
//			op = 1; 
...
//				gButtonPressed[event.xbutton.button] = 1;
				...
				{
				case Button1:
					gButtonPressed[GLUT_LEFT_BUTTON] = 1;break;
				case Button2:
					gButtonPressed[GLUT_MIDDLE_BUTTON] = 1;break;
				case Button3:
					gButtonPressed[GLUT_RIGHT_BUTTON] = 1;break;
				}
				if (gMouseFunc != NULL)
				switch (event.xbutton.button)
				{
...
//				gButtonPressed[event.xbutton.button] = 0;
				...
				{
				case Button1:
					gButtonPressed[GLUT_LEFT_BUTTON] = 0;break;
				case Button2:
					gButtonPressed[GLUT_MIDDLE_BUTTON] = 0;break;
				case Button3:
					gButtonPressed[GLUT_RIGHT_BUTTON] = 0;break;
				}
				if (gMouseFunc != NULL)
				switch (event.xbutton.button)
				{
